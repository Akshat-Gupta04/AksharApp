...
import '/pages/chat_setting/chat_setting_widget.dart';
                                                                  ...
                                                                  StreamBuilder<
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return Icon(
                                                                        Icons
                                                                            .done_all,
                                                                        color: iconChatsRecord?.messageSeen ==
                                                                                true
                                                                            ? FlutterFlowTheme.of(context).primary
                                                                            : FlutterFlowTheme.of(context).secondaryText,
                                                                        size:
                                  ...
                                  onTap: () async {
                                    if (_model.typeSomethingController.text !=
                                      ...
                                      await chatsChatsRecord!.reference
                                        ...
                                        lastMessTime: getCurrentTimestamp,
                                        lastMessage:
                                            _model.typeSomethingController.text,
                                      ));
                                      setState(() {
                                        _model.typeSomethingController?.clear();
                                      });
                                    } else {
                                      ScaffoldMessenger.of(context)
                                          .clearSnackBars();
