...
import '/extra_components/lang_swap/lang_swap_widget.dart';
                        ...
                        StreamBuilder<List<ChatMessagesRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<ChatMessagesRecord>
                                textChatMessagesRecordList = snapshot.data!;
                            // Return an empty Container when the item does not exist.
                            if (snapshot.data!.isEmpty) {
                              return Container();
                            }
                            final textChatMessagesRecord =
                                textChatMessagesRecordList.isNotEmpty
                                    ? textChatMessagesRecordList.first
                                    : null;
                            return InkWell(
                              splashColor: Colors.transparent,
                              focusColor: Colors.transparent,
                              ...
                              highlightColor: Colors.transparent,
                              onTap: () async {
                                await textChatMessagesRecord!.reference
                                    .delete();
