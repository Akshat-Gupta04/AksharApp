...
class AksharAiINTROWidget extends StatefulWidget {
  const AksharAiINTROWidget({super.key});

  @override
  State<AksharAiINTROWidget> createState() => _AksharAiINTROWidgetState();
}

class _AksharAiINTROWidgetState extends State<AksharAiINTROWidget> {
  late AksharAiINTROModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AksharAiINTROModel());
  }
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'hwvso7vz' /* AksharAI  is a powerfull AI as... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
