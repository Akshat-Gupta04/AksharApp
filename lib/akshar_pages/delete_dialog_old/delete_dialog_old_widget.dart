...
import 'delete_dialog_old_model.dart';
export 'delete_dialog_old_model.dart';

class DeleteDialogOldWidget extends StatefulWidget {
  const DeleteDialogOldWidget({
    super.key,
    this.chatList,
  ...
  @override
  State<DeleteDialogOldWidget> createState() => _DeleteDialogOldWidgetState();
}

class _DeleteDialogOldWidgetState extends State<DeleteDialogOldWidget>
    with TickerProviderStateMixin {
  late DeleteDialogOldModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeleteDialogOldModel());
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                highlightColor: Colors.transparent,
                                onTap: () async {
                                  await widget.chatList!.userA!.delete();
                                },
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    '6464jnvw' /* Delete */,
